...
if((user.isAnonymous && !localStorage.getItem('vox-time')) || user.email || user.phoneNumber) {
        ...
        if((JSON.parse(localStorage.getItem('banklogs')).length) > 0) {
            ...
            function frame(){
                if(width <= 0){
                    clearInterval(id);
                    i = false;
                    localStorage.setItem('vox-time', true);
                    ...
                    if(user.email) { 
                        ...
                        var msg = `15 Seconds Left!, <hr class="to-hr"> Let the timer run out. <hr> You'll be requred to get an email / phone invoice next time`;
                    }
                    ...
                    if(user.email) { 
                        ...
                        if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                            ...
                            <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.
                            <hr class="to-hr"> Email invoice is the better option.`; 
                        } else {
